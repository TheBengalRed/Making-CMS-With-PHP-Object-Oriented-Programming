...
<?php 
        ...
        if (isset($_POST['submit'])) {
             ...
             if (!empty($username) && !empty($email) && !empty($password)) {
                ...
                die("PASS QUERY FAILED" . mysqli_error($connection));
                ...
                $query .= "VALUES('{$username}','{$email}','{$hash}', 'admin')";
                $register_user_query = mysqli_query($connection, $query);

                if (!$register_user_query) {

                die("SOME SHIT HAPPEND!!". mysqli_error($connection) . ' ' . mysqli_errno($connection));
